...
# it can be imported as mlperf_common.fileio.direct_io, and not only by the
# scripts installed alongside it in bin/.  This shim keeps `import direct_io`
# working for anything that still expects a module next to fastcp.
